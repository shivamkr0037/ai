        ...
        if part.startswith('data:{"content":"') and part.endswith('"}'):
            ...
            if content:
                if edits_count < 4:
                    ...
                    send_message(context.bot, update.effective_chat.id, previous_message + ' ' + content)
                    break

# Main function to start the bot
def main():
    updater = Updater("6766951129:AAGqyeKYOL-G0tqCNKg-pJxc-6rATFjwzEc", use_context=True)
